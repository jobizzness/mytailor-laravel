...
@section('main')
    ...
    height: 100%;
    max-width: 370px;
    margin: 7em auto;}.mdl-textfield__input{padding: 1em 0;font-size: small;}.mdl-textfield__input:focus{background-color: inherit;}.btn-lg{min-width: 100%;height: 50px;margin-bottom: 20px;}input:-webkit-autofill {-webkit-box-shadow: 0 0 0px 1000px #eee inset;}.mdl-textfield__label:after {background-color: #FB4164;}.mdl-textfield--floating-label.is-focused .mdl-textfield__label, .mdl-textfield--floating-label.is-dirty .mdl-textfield__label, .mdl-textfield--floating-label.has-placeholder .mdl-textfield__label{color: #FB4164;}
    </style>
