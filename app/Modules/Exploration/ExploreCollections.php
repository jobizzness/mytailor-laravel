...
class ExploreCollections implements ExplorationInterface
{
    ...
    public static function explore($items)
    {
        ...
        return $items->transform(function ($item, $key) {
            ...
            $generateScore = ExploreCollections::getScoreGenerator();

            $item->popularity = $generateScore->hotness(5, 0, $item->published_at->timestamp);
