 ...
 */
	...
	app.controller("exploreController", ["$scope","shotsFactory","$filter",
        function($scope, shotsFactory, $filter) {
	...
	app.controller("designersController", ["$scope","designersFactory","NgMap","$Request",
		function($scope, designersFactory, NgMap, $Request, $filter, shotsFactory) {
			$scope.designers = [];
			$scope.busy = false;
            $scope.after = '/?page=1';
            $scope.per_page = 0;
...
app.controller("profileController", ["$scope","designersFactory","NgMap","$Request","$filter","shotsFactory",
    function($scope, designersFactory, NgMap, $Request,$filter,shotsFactory) {
